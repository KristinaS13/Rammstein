...
\
The matrix shows that *Rosenrot* seems to be similar to *RAMMSTEIN*, whereas *Sehnsucht* is quite different from every other album. Sounds promising! \
\
...
### (A)Typical Rammstein: perception and computation FIX
```{r}
...
ADD PLAYLIST, HOW DECIDED ATYPICAL
