---
title: "Rammstein: Exploring Album Acclaim through Spotify (do not show in class)"
...
Choosing top predictors (loudness, danceability, acousticness) and features used for previous analyses (danceability, energy, valence, loudness and tempo) did not majorly improve things (should I add another table with precisions and recalls? The values for both are also awful)
...
constants_plot <- ggplot(data = constants, aes(x = Album, 
                                               y = Value, 
                                               group = Feature)) +
